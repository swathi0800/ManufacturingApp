...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public Cursor getdetails(String Cus_id,SQLiteDatabase sqLiteDatabase){
        String[] projections={DURATION_COL,DESCRIPTION_COL,TRACKS_COL};
        String selection = NAME_COL+" LIKE ?";
        String[] selection_args={Cus_id};
