    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(UpdateCourseActivity.this, "Customer Details Updated..", Toast.LENGTH_SHORT).show();
        ...
        deleteCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(UpdateCourseActivity.this, "Deleted the Customer details", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(UpdateCourseActivity.this, MainActivity.class);
                startActivity(i);
            }
        });
